<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ConsultaColoresWebForm.aspx.cs" Inherits="Web_Car_Sales_System.Consultas.ConsultaColoresWebForm" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td class="auto-style28"><strong>Consulta de Colores</strong></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style25">&nbsp;</td>
        ...
        <tr>
            ...
            <td class="auto-style30">
                <asp:GridView ID="ConsultaGridView" runat="server" Width="438px">
                    <Columns>
                        <asp:HyperLinkField
                        DataNavigateUrlFields="ColorId"
                        DataNavigateUrlFormatString="/Registros/RegistroColoresWebForm.aspx?ColorId={0}"
                        Text="Editar"
