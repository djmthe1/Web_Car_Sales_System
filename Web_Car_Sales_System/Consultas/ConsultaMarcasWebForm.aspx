<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ConsultaMarcasWebForm.aspx.cs" Inherits="Web_Car_Sales_System.Consultas.ConsultaMarcasWebForm" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td class="auto-style28"><strong>Consulta de Marcas</strong></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style25">&nbsp;</td>
        ...
        <tr>
            ...
            <asp:GridView ID="ConsultaGridView" runat="server" Width="438px">
                <Columns>
                    <asp:HyperLinkField
                    DataNavigateUrlFields="MarcaId"
                    DataNavigateUrlFormatString="/Registros/RegistroColoresWebForm.aspx?MarcaId={0}"
                    Text="Editar"
