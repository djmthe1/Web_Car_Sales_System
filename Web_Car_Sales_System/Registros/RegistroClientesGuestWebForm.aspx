...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
             ...
             <strong>Tipo:</strong></td>
                ...
                <asp:DropDownList ID="TipoDropDownList" runat="server" Class="form-control input-sm" CssClass="col-xs-offset-0" Width="125px" style="margin-left: 0px" Height="35px">
                    ...
                    <asp:ListItem Value="4">Otro</asp:ListItem>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="TipoDropDownList" InitialValue="Seleccionar--" ErrorMessage="Debe Seleccionar uno" ForeColor="Red" ValidationGroup="Agregar">*</asp:RequiredFieldValidator>
    ...
    <table class="auto-style1">
        <tr>
            <td class="auto-style59"><strong>Telefonos:</strong></td>
        ...
        <tr>
            ...
            <td class="auto-style27">
                <asp:GridView ID="telefonosGridView" runat="server" AutoGenerateColumns="False" Height="101px" Width="286px" CssClass="auto-style57" >
                    <Columns>
